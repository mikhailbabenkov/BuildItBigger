...
jokeMy, but actually just complains. The banner ad was set up following the
instructions here:
...
Make the button display a toast showing a jokeMy retrieved from your Java jokeMy
telling library.

### Step 2: Create an Android Library

Create an Android Library containing an Activity that will display a jokeMy
passed to it as an intent extra. Wire up project dependencies so that the
button can now pass the jokeMy from the Java Library to the Android Library.
...
jokeMy, then launch the activity from your Android Library to display it.
...
Display the add after the user hits the button, but before the jokeMy is shown.

https://developers.google.com/mobile-ads-sdk/docs/admob/android/interstitial

### Add Loading Indicator

Add a loading indicator that is shown while the jokeMy is being retrieved and
disappears when the jokeMy is ready. The following tutorial is a good place to
start:
...
* The free app variant displays interstitial ads between the main activity and the jokeMy-displaying activity.
* The app displays a loading indicator while the jokeMy is being fetched from the server.
